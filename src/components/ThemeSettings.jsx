    ...
    w-screen fixed nav-item top-0 right-0'>
      ...
      bg-white dark:[#484B52] w-400'>
        <div className='flex justify-between items-center p-4 ml-4'>
          ...
          >
            <MdOutlineCancel className=' hover:drop-shadow-xl
                  hover:bg-dark-gray text-2xl'/>
        ...
        <div className='flex-col border-t-1 border-color p-4 ml-4'>
          ...
          <input
            ...
            value="Light" />
          <label htmlFor='light' className='ml-text-md cursor-pointer'>
            Light
          </label>
          </div>
          ...
          <input
            ...
            value="Dark" />
          <label htmlFor='dark' className='ml-text-md cursor-pointer'>
            Dark 
          </label>
          </div>
