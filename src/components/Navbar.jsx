    ...
    <>
      <div className='flex justify-between p-2 md:mx-6 relative'>
        ...
        <NavButton title="Chat" customFunc={() => {
          handleClick('chat');
        }} color={currentColor} icon={<BsChatLeft />} dotColor="#03C9D7" />
        ...
        <TooltipComponent
         ...
         hover:bg-light-gray 
          rounded-lg'  onClick={() => handleClick('userProfile')}>
            ...
            <p>
              <span className='text-gray-400 text-14 font-bold ml-1'>Hi, </span>{' '}
              <span className='text-gray-400 text-14 font-bold ml-1'> Ashish</span>
            </p>
            <MdKeyboardArrowDown className='text-gray-400 text-14 font-bold ml-1'/>
          </div>
        </TooltipComponent>
        {isClicked.cart && <Cart/>}
        {isClicked.chat && <Chat/>}
